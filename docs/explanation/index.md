...
- [GNC ICP Refinement](gnc_refinement.md): Graduated non-convexity in the SE(2) local refinement — the robust kernel, the per-point stereo noise model that scales it, conditioning, and why the capture radius is still not derived.
